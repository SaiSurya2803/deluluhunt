    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center pb-4 border-b border-slate-200">
        <div>
          ...
          <p className="text-slate-500 mt-1">Real-time platform statistics and alerts.</p>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <CardContent className="p-6">
            <div className="flex justify-between items-start">
              <div>
                ...
                <p className="text-3xl font-bold text-slate-900 mt-1">{stats.totalTeams}</p>
              </div>
        ...
        <Card className="border-slate-200 shadow-sm bg-white">
          <CardContent className="p-6">
            <div className="flex justify-between items-start">
              <div>
                <p className="text-sm font-medium text-slate-500">Quiz Subs</p>
                <p className="text-3xl font-bold text-slate-900 mt-1">{stats.quizSubmissions}</p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex justify-between items-start">
              <div>
                ...
                <p className="text-3xl font-bold text-slate-900 mt-1">{stats.totalCreditsUsed}</p>
              </div>
        ...
        <Card className="border-slate-200 shadow-sm bg-white relative overflow-hidden group">
          <div className={cn("absolute inset-0 opacity-10 pointer-events-none transition-opacity", stats.proctoringAlerts > 0 ? "bg-danger" : "bg-slate-200")}></div>
          <CardContent className="p-6">
            <div className="flex justify-between items-start">
              <div>
                <p className="text-sm font-medium text-slate-500">Proctor Alerts</p>
                <p className={cn("text-3xl font-bold mt-1", stats.proctoringAlerts > 0 ? "text-danger" : "text-slate-900")}>
                  {stats.proctoringAlerts}
                </p>
              </div>
              <div className={cn("p-2 rounded-lg", stats.proctoringAlerts > 0 ? "bg-danger/20 text-danger animate-pulse" : "bg-slate-100 text-slate-400")}>
        ...
        <Card className="border-slate-200 shadow-sm bg-white">
          ...
          <CardContent className="p-6">
             <div className="space-y-4">
                ...
                <div className="flex justify-between items-center text-sm">
                  <span className="text-slate-600">Proctoring AI Engine</span>
                  <span className="px-2 py-1 bg-success/10 text-success rounded-md font-medium text-xs">ONLINE</span>
                </div>
                <div className="flex justify-between items-center text-sm">
                  <span className="text-slate-600">WebRTC Stream Server</span>
